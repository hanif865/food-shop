    ...
    if ( 'stylesheet' === $current_section ) {
      ...
      $settings = apply_filters(
        ...
        array(
          ...
          array(
            'title'     => __( 'Desktop Cart Style ', 'food-store' ),
            'desc'      => __( 'Select cart style that you want to show on desktop.', 'food-store' ),
            'id'        => '_wfs_cart_style',
            'default'   => 'bottom',
            'type'      => 'select',
            'options'   => array(
          ...
          array(
            'title'     => __( 'Mobile Cart Style ', 'food-store' ),
            'desc'      => __( 'Select cart style that you want to show on mobile devices.', 'food-store' ),
            'id'        => '_wfs_mobile_cart_style',
            'default'   => 'mini',
            'type'      => 'select',
            'options'   => array(
              'bottom'   => __( 'Bottom Cart', 'food-store' ),
