  ...
  public function woocommerce_form_field_checkout_asap_fields( $field, $key, $args, $value ) {
	if ( isset( $args['type'] ) && !empty( $args['type'] ) ) {
        ...
        $field = '<ul class="form-row nav-tabs nav checkout-asap-block wfs-schedule-nav-group" role="tablist">
    		            <li class="nav-item">
      			          <a class="nav-link active" data-toggle="tab" role="tab" aria-controls="'.$service_type.'_asap" aria-selected="true" >'.$asap_label.'</a>
    			          </li>
    			          <li class="nav-item">
      			          <a class="nav-link" data-toggle="tab" role="tab" aria-controls="'.$service_type.'_schedule" aria-selected="false">'.$order_later_label.'</a>
    			          </li>
  			          </ul>
        ';
			}
